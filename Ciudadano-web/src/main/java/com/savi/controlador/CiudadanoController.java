...
import com.savi.controlador.util.JsfUtil;
import com.savi.controlador.util.PaginationHelper;
...
public class CiudadanoController implements Serializable {
    ...
    private Ciudadano current;
    private DataModel items = null;
    @EJB
    private com.savi.controlador.CiudadanoFacade ejbFacade;
    ...
    public Ciudadano getSelected() {
        if (current == null) {
            current = new Ciudadano();
            selectedItemIndex = -1;
        }
        return current;
    }

    private CiudadanoFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Ciudadano) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CiudadanoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CiudadanoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CiudadanoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Ciudadano getCiudadano(java.lang.Long id) {
